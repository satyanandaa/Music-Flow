    ...
    <div class="container">
        ...
        <div class="paginationButton">
            <ul style="display: flex; list-style-type: none; color: black; margin: 0 auto; justify-content: center;">
                ...
                <li onclick="pagination(this.value);" style="padding: 10px;" value="4"> 4</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="5"> 5</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="6"> 6</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="7"> 7</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="8"> 8</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="9"> 9</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="10"> 10</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="11"> 11</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="12"> 12</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="13"> 13</li>
                <li onclick="pagination(this.value);" style="padding: 10px;" value="14"> 14</li>
            </ul>
        </div>
